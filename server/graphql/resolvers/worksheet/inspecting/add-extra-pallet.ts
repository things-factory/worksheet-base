...
export const addExtraPalletResolver = {
  async addExtraPallet(_: any, { cycleCountNo, palletId, inspectedBatchNo, inspectedQty, inspectedStdUnitValue, locationName }, context: any) {
...
export async function addExtraPallet(
  ...
  await worksheetController.addExtraPallet(cycleCountNo, palletId, inspectedBatchNo, inspectedQty, inspectedStdUnitValue, locationName)
}
