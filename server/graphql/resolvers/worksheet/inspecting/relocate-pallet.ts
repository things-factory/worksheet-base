...
export const relocatePalletResolver = {
  async relocatePallet(_: any, { worksheetDetailName, inspectedBatchNo, inspectedQty, inspectedWeight, inspectedLocationName }, context: any) {
...
export async function relocatePallet(
  ...
  await worksheetController.relocatePallet(worksheetDetailName, inspectedBatchNo, inspectedQty, inspectedWeight, inspectedLocationName)
}
